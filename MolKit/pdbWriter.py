...
#
# $Header: /opt/cvs/python/packages/share1.5/MolKit/pdbWriter.py,v 1.27.2.2 2015/09/01 00:18:04 sanner Exp $
#
# $Id: pdbWriter.py,v 1.27.2.2 2015/09/01 00:18:04 sanner Exp $
#
...
##     numSeq = 0
    ...
    def write(self, filename, nodes, sort=False, sortFunc=None,
        ...
        if atmRec is True or hetRec is True or multiMol:
        ...
        if not multiMol and not ('  ' or ' ' or '') in [x.chemElem for x in mol.allAtoms.data]:
