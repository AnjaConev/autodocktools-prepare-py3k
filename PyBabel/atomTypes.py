...
#############################################################################
#
# $Header: /opt/cvs/python/packages/share1.5/PyBabel/atomTypes.py,v 1.6 2012/10/19 16:09:49 rhuey Exp $
#
# $Id: atomTypes.py,v 1.6 2012/10/19 16:09:49 rhuey Exp $
#
    ...
    def valence_two(self):
      ...
      for a in self.atoms:
          if len(a.bonds) == 2 and a.babel_organic:
              ...
              if a.coords[0]==l.coords[0] and a.coords[1]==l.coords[1] and a.coords[2]==l.coords[2]:
